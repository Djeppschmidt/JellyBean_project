...
keyVar<-cbind(colVars(as.data.frame(as.matrix(otu_table(refcom)[1:5]))), colVars(as.data.frame(as.matrix(otu_table(refcom)[6:10]))), colVars(as.data.frame(as.matrix(otu_table(refcom)[11:15]))), colVars(as.data.frame(as.matrix(otu_table(refcom)[16:20]))), colVars(as.data.frame(as.matrix(otu_table(refcom)[21:25]))), colVars(as.data.frame(as.matrix(otu_table(refcom)[26:30]))))
